...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Backgrounds */}
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-primary-50/30 to-accent-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950" />
      <AnimatedGrid />
      <GlowingOrbs />
            ...
            >
              <div className="flex -space-x-3">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-white dark:border-slate-900 bg-gradient-to-br from-primary-400 to-accent-400 flex items-center justify-center text-white text-sm font-semibold"
                  >
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Trusted by 500+ businesses</p>
              </div>
            </motion.div>
          </div>
